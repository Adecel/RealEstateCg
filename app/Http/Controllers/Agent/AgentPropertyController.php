...
class AgentPropertyController extends Controller
{
    ...
    public function AgentEditProperty($id){
        ...
        view('agent.property.edit_property',compact('property','propertytype','amenities','property_ami','multiImage','facilities','pstate'));
