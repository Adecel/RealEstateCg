    ...
    <div class="auto-container">
        <div class="inner-container">
            <div class="content-box centred">
                <h2>Trouvez votre propriété maintenant</h2>
                                            ...
                                            <div class="col-lg-4 col-md-12 col-sm-12 column">
                                                <div class="form-group">
                                                    ...
                                                    <div class="field-input">
                                                        ...
                                                        <input type="search" name="search-field" placeholder="Recherche par propriété ou emplacement..." required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                <div class="form-group">
                                                    <label>Emplacement ou location</label>
                                                    <div class="select-box">
                                                        <i class="far fa-compass"></i>
                                                        <select class="wide">
                                                            <option data-display="Localisation de l'entrée">Emplacement d'entrée</option>
                                                            <option value="1">Brazzaville</option>
                                                            <option value="2">Kinshasa</option>
                                                            <option value="3">Pointe Noire</option>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                <div class="form-group">
                                                    ...
                                                    <div class="select-box">
                                                        <select class="wide">
                                                            <option data-display="Nombre maximum de chambres">Nombre maximum de chambres</option>
