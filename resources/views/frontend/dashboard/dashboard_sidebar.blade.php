<div class="widget-content">
    <ul class="category-list ">
        ...
        <li class="current">  <a href="blog-details.html"><i class="fab fa fa-envelope "></i> Tableau de bord </a></li>
        <li><a href="{{ route('user.profile') }}"><i class="fa fa-cog" aria-hidden="true"></i> Paramètres </a></li>
        ...
        <li><a href="{{ route('user.change.password') }}"><i class="fa fa-key" aria-hidden="true"></i> Sécurité </a></li>
        <li><a href="{{ route('user.logout') }}"><i class="fa fa-chevron-circle-up" aria-hidden="true"></i> Se déconnecter </a></li>
    </ul>
</div>
