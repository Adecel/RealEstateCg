...
@section('main')
    @section('title')
        Connexion utilisateur | leFlCG_4,76
    @endsection
                                ...
                                <div class="inner-box">
                                    ...
                                    <form action="{{ route('login') }}" method="post" class="default-form">
                                        ...
                                        <div class="form-group">
                                            <label>E-mail, Nom ou Téléphone </label>
                                            <input type="text" name="login" id="login" required="" placeholder="E-mail, Nom ou Téléphone">
                                        </div>
                                        ...
                                        <div class="form-group message-btn">
                                            <button type="submit" class="theme-btn btn-one">Je me connecte</button>
                                        </div>
                                    </form>
                                    <div class="othre-text">
                                        <p>Vous n'avez pas de compte ? <a href="signup.html">S'inscrire maintenant</a></p>
                                    </div>
                                </div>
                            </div>
