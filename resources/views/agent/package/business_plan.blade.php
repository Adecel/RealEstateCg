...
@section('agent')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Pages spéciales</a></li>
                        ...
                        <div class="card-body">
                            <div class="container-fluid d-flex justify-content-between">
                                ...
                                <div class="col-lg-3 pe-0">
                                    ...
                                    <h4 class="text-end fw-normal">2000 XAF</h4>
                                ...
                                <div class="table-responsive w-100">
                                    <table class="table table-bordered">
                                        ...
                                        <tr class="text-end">
                                            ...
                                            <td class="text-start">Entreprise</td>
                                            <td>3</td>
                                            <td>2000 XAF</td>
                                            <td>2000 XAF</td>
                                    ...
                                    <div class="col-md-6 ms-auto">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>Sous-total</td>
                                                    <td class="text-end">2000 XAF</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-bold-800">Total</td>
                                                    <td class="text-bold-800 text-end"> 2000 XAF</td>
                                                </tr>
                                                <tr>
                                                    <td>Paiement effectué</td>
                                                    <td class="text-danger text-end">(-) 2000 XAF</td>
                                                </tr>
                                                <tr class="bg-dark">
