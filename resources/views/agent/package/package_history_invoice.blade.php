...
<table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
            ...
            <h2 style="color: green; font-size: 26px;"><strong>Le Fleuve CG - 4,76</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Le Fleuve CG - 4,76 _ Bureau central
               Email:support@fleuvecg.com
               Tel: 0813623440
               64 parlands main
            </pre>
        </td>
    ...
    <tr>
        <td>
            <p class="font" style="margin-left: 20px;">
                ...
                <strong>E-mail:</strong> {{ $packagehistory->user->email }} <br>
        ...
        <td>
            ...
            Type de paiement : Contre remboursement </span>
            </p>
        </td>
    </tr>
    <br><br>
...
<br/><br><br>
<h3>Forfait Gestion de Propriété</h3>
...
<table width="100%">
    ...
    <tr class="font">
        ...
        <td align="center">{{ $packagehistory->package_amount }} XAF</td>
        <td align="center">{{ $packagehistory->package_amount }} XAF</td>
