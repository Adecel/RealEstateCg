                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('agent.update.property') }}" id="myForm" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="property_status" class="form-select" id="exampleFormControlSelect1">
                                                ...
                                                <option value="buy" {{ $property->property_status == 'buy' ? 'selected' : '' }}>A Vendre</option>
                                            </select>
                                        </div>
                                    </div><!-- Col -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank">Allez ici pour obtenir Longitude à partir de l'adresse</a>
                                        </div>
                                    </div><!-- Col -->
                                </div><!-- Row -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            <label class="form-label">Commodités de la propriété</label>
        ...
        <div class="row profile-body">
            <div class="col-md-12 col-xl-12 middle-wrapper">
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Modifier l'image miniature principale</h6>
        ...
        <div class="row profile-body">
            <div class="col-md-12 col-xl-12 middle-wrapper">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Modifier plusieurs images</h6>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($multiImage as $key => $img)
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="submit" class="btn btn-primary px-4" value="Mettre à jour l'image" >

                                                    <a href="{{ route('agent.property.multiimg.delete',$img->id) }}" class="btn btn-danger" id="delete">SUPPRIMER </a>
                                                </td>
                                            </tr>
                                        @endforeach
                            ...
                            <form method="post" action="{{ route('agent.store.new.multiimage') }}" id="myForm" enctype="multipart/form-data">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="submit" class="btn btn-info px-4" value="Ajouter une image" >
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
        ...
        <div class="row profile-body">
            <div class="col-md-12 col-xl-12 middle-wrapper">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">MODIFIER Les facilités DE LA PROPRIÉTÉ</h6>
                                                ...
                                                <div class="container mt-2">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <label for="facility_name">Les facilités</label>
                                                            <select name="facility_name[]" id="facility_name" class="form-control">
                                                                <option value="">Sélectionner les facilités</option>
                                                                <option value="Hospital" {{ $item->facility_name == 'Hospital' ? 'selected' : ''  }} >Hôpital</option>
                                                                <option value="SuperMarket" {{ $item->facility_name == 'SuperMarket' ? 'selected' : ''  }}>Super Marché</option>
                                                                <option value="School" {{ $item->facility_name == 'School' ? 'selected' : ''  }}>École</option>
                                                                <option value="Entertainment" {{ $item->facility_name == 'Entertainment' ? 'selected' : ''  }}>Divertissement</option>
                                                                <option value="Pharmacy" {{ $item->facility_name == 'Pharmacy' ? 'selected' : ''  }}>Pharmacie</option>
                                                                <option value="Airport" {{ $item->facility_name == 'Airport' ? 'selected' : ''  }}>Aéroport</option>
                                                                <option value="Railways" {{ $item->facility_name == 'Railways' ? 'selected' : ''  }}>Chemins de fer</option>
                                                                <option value="Bus Stop" {{ $item->facility_name == 'Bus Stop' ? 'selected' : ''  }}>Arrêt de bus</option>
                                                                <option value="Beach" {{ $item->facility_name == 'Beach' ? 'selected' : ''  }}>Plage</option>
                                                                <option value="Mall" {{ $item->facility_name == 'Mall' ? 'selected' : ''  }}>Centre commercial</option>
                                                                <option value="Bank" {{ $item->facility_name == 'Bank' ? 'selected' : ''  }}>Banque</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group col-md-4">
        ...
        $(document).ready(function (){
            $('#myForm').validate({
                ...
                messages :{
                    ...
                    lowest_price: {
                        required : 'Veuillez entrer le prix minimum',
                    },
                    max_price: {
                        required : 'Veuillez entrer le prix maximum',
                    },
                    ptype_id: {
