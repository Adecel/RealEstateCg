        ...
        <div class="bee-row-content">
            ...
            <div class="bee-col bee-col-2 bee-col-w5">
                ...
                <div class="bee-block bee-block-2 bee-heading">
                    <h1 style="color:#199e59;direction:ltr;font-family:'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:74px;font-weight:700;letter-spacing:normal;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">FleuveCG_4,76<br/> </h1>
                </div>
                <div class="bee-block bee-block-3 bee-paragraph">
                    <p>Votre partenaire immobilier de confiance depuis 4,76 ans. <br> Email:support@fleuvecg.com</p>
                </div>
...
{{--                        <span dir="ltr" style="word-break: break-word; font-size: 14px; line-height: 200%; letter-spacing: 1px;">DISCOVER</span>--}}
{{--                    </a>--}}
{{--                </div>--}}
            </div>
    ...
    <div class="bee-row bee-row-5">
        <div class="bee-row-content">
            ...
            <div class="bee-col bee-col-2 bee-col-w8">
                <div class="bee-block bee-block-1 bee-paragraph">
                    <p><strong>Bonjour monsieur ou madame</strong><br/><strong>Votre demande est confirmée sur ces données.</strong></p>

                    <h3> Tour Date : {{ $schedule['tour_date'] }} </h3>
                    <h3> Tour Time : {{ $schedule['tour_time'] }}</h3>

                    <p>
                        Nous nous réjouissons à l'idée de vous faire découvrir votre futur chez-vous lors de cette visite et nous prendrons le temps de répondre à toutes vos questions et de vous présenter des solutions sur mesure pour concrétiser vos projets immobiliers. Votre confiance est notre priorité, et nous sommes là pour faire de cette expérience une étape agréable et réussie.
                        <br> <br>
                        N'hésitez pas à nous contacter à l'adresse email support@fleuvecg.com pour toute question supplémentaire.
                        <br> <br>
                        Cordialement,
                    </p>
                </div>
...
{{--                    <a class="bee-button-content" href="http://www.example.com" style="font-size: 14px; background-color: #3c3c3c; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 20px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; direction: ltr; font-family: inherit; font-weight: 400; letter-spacing: 1px; max-width: 100%; padding-bottom: 5px; padding-left: 40px; padding-right: 40px; padding-top: 5px; width: auto; display: inline-block;" target="_self">--}}
{{--                        <span dir="ltr" style="word-break: break-word; font-size: 14px; line-height: 200%; letter-spacing: 1px;">READ MORE</span>--}}
{{--                    </a>--}}
{{--                </div>--}}
            </div>
...
{{--            </div>--}}
            <div class="bee-col bee-col-3 bee-col-w6">
                <div class="bee-block bee-block-1 bee-text">
                    <div class="bee-text-content" style="line-height: 120%; font-size: 12px; font-family: inherit; color: #fafafa;">
                        <p style="font-size: 14px; line-height: 16px; text-align: center;"><span style="font-size: 18px; line-height: 21px;"><strong style=""><span style="line-height: 14px;">Contactez-nous</span></strong></span></p>
                    </div>
                </div>
                <div class="bee-block bee-block-2 bee-text">
                    <div class="bee-text-content" style="line-height: 150%; font-size: 12px; font-family: inherit; color: #fafafa;">
                        <p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;">Le Fleuve CG - 4,76 _ Bureau central 64 parlands main</span></p>
                        <p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;"> support@fleuvecg.com</span></p>
                        <p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;"> (+27) 0813623440</span></p>
                    </div>
                </div>
            </div>
